...
Version  : 7.2
Release  : 33
URL      : https://download.samba.org/pub/linux-cifs/cifs-utils/cifs-utils-7.2.tar.bz2
Source0  : https://download.samba.org/pub/linux-cifs/cifs-utils/cifs-utils-7.2.tar.bz2
Source1  : https://download.samba.org/pub/linux-cifs/cifs-utils/cifs-utils-7.2.tar.bz2.asc
...
%setup -q -n cifs-utils-7.2
cd %{_builddir}/cifs-utils-7.2
pushd ..
cp -a cifs-utils-7.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739545457
